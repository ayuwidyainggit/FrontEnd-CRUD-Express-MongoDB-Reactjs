...
import { useNavigate, useParams } from 'react-router-dom'; //useNavigate untuk redirect , useParam untuk mengambil id dr parameter
...
const EditUser = () => {
  ...
  //   untuk memanggil function getUserById tambahkan useEffect
  useEffect(() => {
    getUserById();
  }, []);
